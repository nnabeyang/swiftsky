...
struct FeedDefsPostViewEmbed: Decodable, Hashable {
    ...
    init(from decoder: Decoder) throws {
        ...
        case "app.bsky.embed.recordWithMedia#view":
            ...
            record = try recordcontainer.decodeIfPresent(EmbedRecordViewRecord.self, forKey: .record)
            let mediacontainer = try container.nestedContainer(keyedBy: CodingKeys.recordWithMedia.self, forKey: .media)
            images = try mediacontainer.decodeIfPresent([EmbedImagesViewImage].self, forKey: .images)
